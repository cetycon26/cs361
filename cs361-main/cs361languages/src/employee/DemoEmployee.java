...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		emp3.whoAmI();
		// TODO To complete
		//emp3.whoAmI(); // prints ... "PART TIME EMPLOYEE" because ... the toString() method of the PartTimeEmployee class is set to print "PART TIME EMPLOYEE"
		//emp3.getHourlyRate(); // returns syntax error because ... for the Employee class, there is no "getHourlyRate()" method defined
...
//		PartTimeEmployee pEmp3 = (PartTimeEmployee) emp1;
		...
		// because ... emp1, which is of type Employee, cannot be cast to class PartTimeEmployee. These are two objects with different constructor parameters.
